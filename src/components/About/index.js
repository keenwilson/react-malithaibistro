        ...
        <div className="row">
          <div className="col-md-6">
            <p className="p-article pl-5">
              ...
              handed down from generation-to-generation. This passion for
              cooking led each of Chef Nutnisa's older sisters to open
              restaurants in Thailand, one in Bangkok and one on the island Koh
              Samui.
            </p>
          </div>
          <div className="col-md-6">
            <p className="p-article pr-5">
              ...
              HighSchool. Mali Thai Bistro was named in honor of Chef Nutnisa’s
              mother, with Mali being the name of a jasmine flower that she
              loved.
            </p>
          </div>
        </div>
